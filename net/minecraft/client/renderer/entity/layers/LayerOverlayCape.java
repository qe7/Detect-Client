...
public class LayerOverlayCape implements LayerRenderer<AbstractClientPlayer>
{
    private final RenderPlayer playerRenderer;

    public LayerOverlayCape(RenderPlayer playerRendererIn)
    {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
        if (entitylivingbaseIn.getName().equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.getName())&& Detect.i.moduleManager.getModuleByName("Cape").isToggled() && Cape.hasOverlay) {
            ...
            this.playerRenderer.bindTexture(new ResourceLocation("cape/" + Cape.getOverlay() + ".png"));
