package github.qe7.detect.ui.menu.other;
...
public class GuiCustomButton extends Gui {
	protected static final ResourceLocation buttonTextures = new ResourceLocation("Detect/Gui/widgets.png");
	...
	public void drawCustomButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			font.drawCenteredStringWithShadow(this.displayString, this.xPosition + this.width / 2,
