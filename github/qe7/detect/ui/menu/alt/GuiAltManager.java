package github.qe7.detect.ui.menu.alt;

import java.io.IOException;
import java.util.Random;

import github.qe7.detect.ui.menu.other.AltLoginThread;
import github.qe7.detect.ui.menu.other.PasswordField;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        mc.font.drawCenteredString("Alt Login", width / 2, 20, -1);
        mc.font.drawCenteredString(this.thread == null ? (Object)((Object)EnumChatFormatting.GRAY) + "Idle..." : this.thread.getStatus(), width / 2, 29, -1);
//        if (this.username.getText().isEmpty()) {
//        	mc.font.drawCenteredString("Username / E-Mail", width / 2 - 54 + 7, 66, -7829368);
//        }
//        if (this.password.getText().isEmpty()) {
//        	mc.font.drawCenteredString("Password", width / 2 - 74 + 4, 106, -7829368);
//        }
    ...
    public String genString() {
        ...
        String generatedString = "Femboy_" + random.ints(leftLimit, rightLimit + 1)
